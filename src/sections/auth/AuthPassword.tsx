...
const AuthPasswordWrapper = ({ children }: Props) => {
  const intl = useIntl()
  ...
  return (
    (
      <Box sx={{ minHeight: '100vh', background: '#f6f5fa' }}>
        {/* <AuthBackground /> */}
        <Grid
          container
          direction="column"
        ...
        >
          <div style={{ width: '100%' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center'}}>
              ...
              <TabButton style={{ borderRadius: '10px', marginLeft: '10px'}}>
                <div style={{ display: 'flex', alignItems: 'center'}}>
          ...
          <Grid item xs={12} >
            <Grid
              ...
              alignItems="center"
              sx={{ minHeight: { xs: 'calc(100vh - 210px)', sm: 'calc(100vh - 511px)', md: 'calc(100vh - 511px)', display: 'flex', flexDirection: 'column' } }}
            >
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', width: '460px'}}>
                <img src={backIcon}/>
                <span style={{ color: '#686b82', fontSize: '16px' }}>
              ...
              <Grid item>
                <AuthCard style={{borderRadius: '20px', margin: '10px'}}>{children}</AuthCard>
              </Grid>
...
export default AuthPasswordWrapper;
